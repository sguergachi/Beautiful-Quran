...
data class InkLabSnapshot(
    ...
    val guideBodyEdge: Float = 0.38f,
    val guideFeatherWidth: Float = 0.34f,
    val guideFadeSoftness: Float = 1.4f,
    val guideBlurRadiusDp: Float = 10f,
    val guideBlurStrength: Float = 0.9f,
    val guideVellumGrain: Float = 0.035f,
    val guideVerticalTaper: Float = 0.025f,
