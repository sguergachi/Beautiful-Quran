...
app/                    The entire Android app (single Gradle module)
  src/main/java/com/beautifulquran/
    ...
    tarjilab/           Dev lab: capture a word, mark the hold, sculpt its
                        envelope, and tune that reciter's tarjīʿ detector
...
| `docs/TARJI_LAB.md` | The tarjīʿ lab — reciter-signature hold tuner, samples, capture edges |
