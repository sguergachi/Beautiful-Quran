...
export interface AppState {
   ...
   */
  pendingSearchFlash: { ayah: number; wordPosition: number; text?: string } | null
}
...
class AppStore {
  ...
  openSurah(surahId: number, ayah = 1, wordPosition?: number, searchText?: string) {
    const reciter =
    ...
    const flash =
      flashWord != null ? { ayah: openAyah, wordPosition: flashWord, text: searchText } : null
