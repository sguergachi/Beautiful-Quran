...
an unsaved verse the empty bookmark tip keeps the outer lane while green uses
the inner lane; the two never overpaint.
...
lane remains interactive. When one verse owns both meanings, ruby keeps the
